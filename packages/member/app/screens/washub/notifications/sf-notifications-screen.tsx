...
export const SFNotificationsScreen: FC<
...
const Logging = () => {
  ...
  useEffect(() => {
    console.log(authState.profile.UserId);
    MCReactModule.setContactKey(authState.profile.UserId.toString());
  ...
  const handleDeviceId = async () => {
    ...
    console.log("sssssss", deviceIdentifier);
