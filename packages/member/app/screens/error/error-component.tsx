...
export const ErrorComponent = (props: ErrorComponentProps) => {
  return (
    <View style={CONTAINER}>
      ...
      <Text style={TITLE_ERROR} text={translate("errorScreen.title")} />
      <Text style={FRIENDLY_SUBTITLE} text={translate("errorScreen.friendlySubtitle")} />
      ...
      <Button style={BTN_RESET} onPress={props.onReset} text={translate("errorScreen.reset")} />
    </View>
  )
}
