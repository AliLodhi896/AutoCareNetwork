...
import { styles } from "../../screens/login/login-screen.styles";
...
GoogleSignin.configure({
  ...
  webClientId:
  "881162078508-ni2kdn52ngdsimbdihdv7u0gjpno50it.apps.googleusercontent.com", // client ID of type WEB for your server (needed to verify user ID and offline access)
  offlineAccess: true, // if you want to access Google API on behalf of the user FROM YOUR SERVER
  iosClientId:
  "881162078508-ni2kdn52ngdsimbdihdv7u0gjpno50it.apps.googleusercontent.com",
});
